/* example) export const KEYNAME = "keyname"; */

/* useUser */
export const USE_USER = "useUserKey";

/* records */
export const RECORDS_CREATE = "recordsCreateKey";
...
export const CHART_RESULT_READ = "chartResultReadKey";
...
/* help 관련 키 */
export const HELP_FIND_ID = "helpFindIdKey";
export const HELP_FIND_PASSWORD = "helpFindPasswordKey";
